 ...
 * Replace src/api/gemini.js with this to use the backend proxy
 * This file should be placed in frontend/src/api/ and imported instead of gemini.js
 * 
 * Usage: Change import in analyzeChart.js from './gemini' to './backendAdapter'
 */
...
function getBackendUrl() {
  return import.meta.env.VITE_BACKEND_URL || 'https://chartai-backend.onrender.com';
}
