...
const STEPS = [
  {
    ...
    tips: [
      { icon: '📊', color: 'rgba(41,98,255,0.2)', text: 'Use both a Higher Timeframe (H4/D1) and a Lower Timeframe (M15/M5)' },
      { icon: '✂️', color: 'rgba(41,98,255,0.2)', text: 'Crop tightly around the price action' },
      { icon: '🔖', color: 'rgba(8,153,129,0.2)', text: 'Label each chart with its correct timeframe' },
      { icon: '🌐', color: 'rgba(209,163,63,0.2)', text: 'Works with any instrument — Forex, Crypto, Indices, Commodities' },
    ],
  },
  {
    id: 2,
    ...
    tips: [
      { icon: '🔍', color: 'rgba(41,98,255,0.2)', text: 'Detects Order Blocks, Fair Value Gaps, and Break of Structure (BOS)' },
      { icon: '📐', color: 'rgba(41,98,255,0.2)', text: 'Aligns HTF bias with LTF entry precision' },
      { icon: '⚡', color: 'rgba(209,163,63,0.2)', text: 'Identifies liquidity sweeps, CHoCH, and premium/discount zones' },
      { icon: '⏱️', color: 'rgba(8,153,129,0.2)', text: 'Full analysis in under 10 seconds' },
    ],
  },
  {
    id: 3,
    ...
    tips: [
      { icon: '🏆', color: 'rgba(8,153,129,0.2)', text: 'Every setup graded A+ to F — only trade A or B rated setups' },
      { icon: '🎯', color: 'rgba(41,98,255,0.2)', text: 'Exact entry zone, stop loss buffer, and take profit levels included' },
      { icon: '📋', color: 'rgba(41,98,255,0.2)', text: 'Check the confluence checklist before trading' },
      { icon: '💾', color: 'rgba(209,163,63,0.2)', text: 'Save to history, export as PDF, or share via WhatsApp / Telegram' },
    ],
  },
];
  ...
  return (
    ...
    >
      <div
        ...
        style={{ '--ob-accent': current.accent }}
      >
